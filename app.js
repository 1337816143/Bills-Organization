...
addStyle(`./swipe-v103.css?app=${BUILD}`);
...
load(`./category-engine.js?app=${BUILD}`,()=>load(`./project-intelligence.js?app=${BUILD}`,()=>load(`./mobile-review.js?app=${BUILD}`,()=>load(`./immersive-review.js?app=${BUILD}`,()=>load(`./compat-fix.js?app=${BUILD}`,()=>load(`./swipe-card-complete.js?app=${BUILD}`,()=>load(`./swipe-v103.js?app=${BUILD}`,()=>load(`./app-shell.js?app=${BUILD}`,()=>load(`./replace-import.js?app=${BUILD}`)))))))));
})();