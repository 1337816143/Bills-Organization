...
addStyle('./immersive-review.css?v=20260816b');
...
load('./category-engine.js?v=20260816',()=>load('./mobile-review.js?v=20260816',()=>load('./immersive-review.js?v=20260816b',()=>load('./app-shell.js?v=20260816'))));
})();